...
def simulate_multiple_cycles(player: Player, cycles: int = 5, trainings_per_cycle: int = 30):
    ...
    for cycle in range(cycles):
        ...
        print(f"Разброс белых навыков после цикла {cycle + 1}: {analyze_white_skills_balance(current_player_after_cycle)}")
...
def main():
    print("=== Тест: Проверка поведения планировщика для игрока Geringer ===\n")
    ...
    simulate_multiple_cycles(player, cycles=5, trainings_per_cycle=30)
