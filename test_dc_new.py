#!/usr/bin/env python3
"""
Script to test DC player training and analyze results with fresh imports
"""
...
if 'domain.training_planner' in sys.modules:
    importlib.reload(sys.modules['domain.training_planner'])
if 'domain.training_recommender' in sys.modules:
    importlib.reload(sys.modules['domain.training_recommender'])
if 'storage.player_repository' in sys.modules:
    importlib.reload(sys.modules['storage.player_repository'])
